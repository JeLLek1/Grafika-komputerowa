...
void App::init() {
    ...
    Material* material = new Material(Vector4<GLfloat>(0.f, 0.f, 0.f, 1.f),
        Vector4<GLfloat>(0.2f, 0.2f, 0.2f, 1.f),
        Vector4<GLfloat>(1.f, 1.f, 1.f, 1.f), 20.0f);
    // wczytanie tekstury
    Texture* tex = nullptr;
    try {

        tex = new Texture(TEX_FILE, TRIANGLES_COUNT, FRAMES_COUNT, FRAME_TIME);
    }
    ...
    Egg* egg = new Egg(EGG_RESSOLUTION, material, tex,
